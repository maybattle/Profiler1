...
class CorProfilerCallback : public ICorProfilerCallback3
{
public:
	CorProfilerCallback(void);
	// ICorProfilerCallback Schnittstellen Implementation
	...
	// Ende ICorProfilerCallback Interface Implementation
	...
	// Ende ICorProfilerCallback2 interface Implementation
	...
	// Ende ICorProfilerCallback3 Implementation
};
